...
ggsave("../plots/ex_upscale/data.map.png", plot = data.map)
...
ggsave("../plots/ex_upscale/geo_clusters_map.png", plot = geo_clusters_map)
...
ggsave("../plots/ex_upscale/comb_box_plot.png", plot = combined_plot)
