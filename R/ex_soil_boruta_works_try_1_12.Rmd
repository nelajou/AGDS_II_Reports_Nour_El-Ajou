...
```{r}
prop.table(table (df_obs$waterlog.100) )
...
df_test$pred <- prediction$predictions #this is why we need another for the borutacase
```
...
# summary(df_map_bor == df_map)
# summary(df_predict_bor == df_predict)
